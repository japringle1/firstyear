...
public class HierarchicalLayout extends JFrame {
	...
	public static void main(String[] args) throws MalformedURLException {
		new HierarchicalLayout(
				new ImageIcon(
						new URL(
								"http://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Alligator_mississippiensis_-_Oasis_Park_-_13.jpg/800px-Alligator_mississippiensis_-_Oasis_Park_-_13.jpg")));
	}
}
