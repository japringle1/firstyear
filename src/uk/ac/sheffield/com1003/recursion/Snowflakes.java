...
public class Snowflakes {
	...
	void star(int xCentre, int yCentre, int radius, int recursions) {
		...
		graphics.drawLine(xCentre - diagonalDelta, yCentre - diagonalDelta,
				xCentre + diagonalDelta, yCentre + diagonalDelta);
		graphics.drawLine(xCentre + diagonalDelta, yCentre - diagonalDelta,
				xCentre - diagonalDelta, yCentre + diagonalDelta);
		...
		if (recursions > 0) {
			...
			star(xCentre - diagonalDelta, yCentre - diagonalDelta, newRadius,
					recursions);
			star(xCentre + diagonalDelta, yCentre - diagonalDelta, newRadius,
					recursions);
			star(xCentre - diagonalDelta, yCentre + diagonalDelta, newRadius,
