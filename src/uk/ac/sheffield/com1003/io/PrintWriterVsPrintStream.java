...
public class PrintWriterVsPrintStream {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] data = { "Fox and Duck", "Grindstone", "Ball",
				"Devonshire Cat", "Sportsman", "Three Merry Lads", "Fox House",
		...
		System.out
				.println("Now close the files and open them files again.  Have a nice day!");
