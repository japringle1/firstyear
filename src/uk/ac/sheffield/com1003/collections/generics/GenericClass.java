...
public class GenericClass<T> {
	...
	public static void main(String[] args) {
		GenericClass<Lecturer> l = new GenericClass<Lecturer>(new Lecturer(
				"Phil McMinn"));
		l.printClass();

		GenericClass<Animal> a = new GenericClass<Animal>(new Animal("Dog"));
		a.printClass();

		GenericClass<Double> d = new GenericClass<Double>(0.42);
		d.printClass();
	}
}
